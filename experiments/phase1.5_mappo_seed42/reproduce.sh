...
# Reproduces run: phase1.5_mappo_seed42
...
# 4. Re-run training
echo "[reproduce] running: bash scripts/run_train.sh configs/laser_25x25_mappo.yaml logs/phase1.5_mappo.log"
...
RUN_DIR="$REPO_DIR/experiments/phase1.5_mappo_seed42"
python scripts/experiments/parse_log_to_metrics.py \
    --log "$RUN_DIR/train.log" \
    --out "$RUN_DIR/metrics.json" \
    --run-id phase1.5_mappo_seed42
python scripts/experiments/make_figures.py \
    --run phase1.5_mappo_seed42:"$RUN_DIR/metrics.json" \
